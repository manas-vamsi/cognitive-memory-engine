...
This specification outlines the hybrid **Python/Rust** tech stack and provides a production-ready directory structure designed for the **Cognitive Memory Engine (CME)**. Pass this document directly to **Claude Code** to initialize your repository, generate boilerplates, or write a comprehensive `README.md`.
...
└── README.md                    # Project overview (to be generated by Claude Code)
```
